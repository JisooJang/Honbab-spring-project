    ...
    function drawChart() {
        ...
        // Create the data table.
         var data = google.visualization.arrayToDataTable([
                                                              ...
                                                              <c:forEach items="${rankingList}" var="entry">
                                                                  [ '${entry.rest_ctg}', ${entry.count_ctg} ],
                                                              </c:forEach>
                                                        ]);
        ...
        // Set chart options
        var options = {
            'title' : 'Ranking Rstaurant by Category!', //title which will be shown right above the Google Pie Chart
            titleTextStyle : {
            	fontSize : 30
            },
