...
import org.springframework.samples.honbab.controller.AccountForm;
...
public class AccountFormValidator implements Validator {
	...
	public void validate(Object obj, Errors errors) {
		...
		if (accountForm.isNewAccount()) {
			...
			ValidationUtils.rejectIfEmptyOrWhitespace(errors, "account.name", "USER_ID_REQUIRED", "User ID is required.");
